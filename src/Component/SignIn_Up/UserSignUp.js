...
export default function UserSignUp() {
  ...
  const handleSubmit = (e) => {
    ...
    if (!validator.isEmail(Detail.username)) {
      ...
      RegistrationService.registerUser(user_details)
        .then((response) => {
      ...
      <div className="register">
                ...
                <div className="user_form_grid">
                  ...
                  <LocalizationProvider dateAdapter={AdapterDateFns}>
                    <DatePicker
                      ...
                      onChange={(newValue) => {
                        setDetail({ ...Detail, dateOfBirth: newValue });
                      }}
                      renderInput={(params) => (
        ...
        <div className="reg_info">
          ...
          <p>
            ...
            help others". If you began donating blood at age 18 and donated
            every 90 days until you reached 60, you would have donated 30
