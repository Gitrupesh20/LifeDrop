      ...
      <div ref={header_height} id="header" className="header">
        <div className="title">
          <h1 style={{ fontSize: "45px" }}>
            Every drop of donated blood is a gift of life.
          </h1>
          <p>
            <span>
          ...
          <section className="serviceBtn">
            <button
              onClick={(e) => {
                window.open("/search-for-blood", "_self");
              }}
            >
              Find A Blood Donor &nbsp; &#10095;
            </button>
        ...
        <div className="head_Img">
          <img
            className="bldrop"
            src={process.env.PUBLIC_URL + "/assets/bldrop.png"}
            alt=""
          />
        ...
        <div>
          ...
          <div className="infoContainer">
            <section className="infoDetails">
              <div>
                <img
                  src={process.env.PUBLIC_URL + "/assets/fact1.png"}
                  alt="Fact"
                />
              </div>
              <p>
            ...
            <section className="infoDetails">
              <div>
                <img
                  src={process.env.PUBLIC_URL + "/assets/fact2.png"}
                  alt="Fact"
                />
              </div>
              <p>
            ...
            <section className="infoDetails">
              <div>
                <img
                  src={process.env.PUBLIC_URL + "/assets/fact3.png"}
                  alt="Fact"
                />
              </div>
              <p>
            ...
            <section className="infoDetails">
              <div>
                <img
                  src={process.env.PUBLIC_URL + "/assets/fact4.png"}
                  alt="Fact"
                />
              </div>
              <p>
  ...
  return (
    <>
      <div
        ...
        style={{
          backgroundImage: `url(${
            process.env.PUBLIC_URL + "/assets/contact_bg.png"
          })`,
        }}
      >
        <p>
